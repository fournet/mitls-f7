...
type FlexConstants =
    ...
    //BB FIXME : This should be a function returning a list depending on the protocol version
    ...
    //BB TODO : All functions should be moved out of FlexConstants.fs
    ...
    // BB : Should the sigAlg be a function ?
