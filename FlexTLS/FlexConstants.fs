...
type FlexConstants =
    ...
    static member calgs_RSA = [(SA_RSA, SHA256);(SA_RSA, MD5SHA1);(SA_RSA, SHA);(SA_RSA, NULL)]
    ...
    static member nullFClientHello : FClientHello = {   pv = defaultConfig.maxVer;
                                              rand = empty_bytes; 
                                              sid = empty_bytes;
    ...
    static member nullFServerHello : FServerHello = {   pv = defaultConfig.maxVer;
                                              rand = empty_bytes; 
                                              sid = empty_bytes;
    ...
    static member nullFCertificate : FCertificate = {   chain = [];
                                              payload = empty_bytes;
                                          }
    ...
    static member nullFCertificateRequest : FCertificateRequest = { certTypes = [RSA_sign; DSA_sign];
                                                          sigAlgs = [];
                                                          names = [];
                                                          payload = empty_bytes;
                                                        }
    ...
    static member nullFCertificateVerify : FCertificateVerify = { sigAlg = FlexConstants.calgs_RSA.Head;
                                                        signature = empty_bytes;
                                                        payload = empty_bytes;
                                                      }

    (* Define a null FServerKeyExchange record for all DH key exchange mechanisms *)
    static member nullFServerKeyExchangeDHx : FServerKeyExchange = { sigAlg = FlexConstants.calgs_DHx.Head;
                                                              signature = empty_bytes;
    ...
    static member nullFServerHelloDone : FServerHelloDone =  { payload = empty_bytes;
                                                   }

    (* Define a null FClientKeyExchange record for RSA *)
    static member nullFClientKeyExchangeRSA : FClientKeyExchange = { kex = RSA(empty_bytes);
                                                              payload = empty_bytes;
                                                            }

    (* Define a null FClientKeyExchange record for DHx *)
    static member nullFClientKeyExchangeDHx : FClientKeyExchange = { kex = DH(FlexConstants.nullKexDH);
                                                              payload = empty_bytes;
                                                            }

    (* Define a null FChangeCipherSpecs record *)
    static member nullFChangeCipherSpecs : FChangeCipherSpecs = { payload = HandshakeMessages.CCSBytes;
                                                      }

    (* Define a null FFinished record *)
    static member nullFFinished : FFinished = {   verify_data = empty_bytes;
                                        payload = empty_bytes;
                                    }

    (* Define a null FHSMessages record *)
    static member nullFHSMessages = {   helloRequest = FlexConstants.nullFHelloRequest;
    ...
    static member nullSessionInfo = {    clientID = [];
    ...
    static member nullNextSecurityContext = {   si = FlexConstants.nullSessionInfo;
                                      crand = empty_bytes;
                                      srand = empty_bytes;
                                      kex = RSA(empty_bytes);
                                      pms = empty_bytes;
