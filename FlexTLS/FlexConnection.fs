...
type FlexConnection =
    ...
    static member init (role:Role,ns:NetworkStream) : state =
        ...
        { read  = { record = record_s_in ; epoch = ci.id_in; hs_buffer = empty_bytes; alert_buffer = empty_bytes};
          write = { record = record_s_out; epoch = ci.id_out; hs_buffer = empty_bytes; alert_buffer = empty_bytes};
          ns = ns }
