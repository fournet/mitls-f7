...
val hmac: hashAlg -> key -> bytes -> bytes Result
(*
val hmacsha1: key -> bytes -> bytes Result
val hmacmd5: key -> bytes -> bytes Result
*)

val hmacVerify: hashAlg -> key -> bytes -> bytes -> unit Result
(*
...
val encrypt: key -> bytes -> bytes -> bytes Result
val decrypt: key -> bytes -> bytes -> bytes Result
(*
...
val des_decrypt_wiv_nopad: key -> bytes -> bytes -> bytes Result
val aes_decrypt_wiv_nopad: key -> bytes -> bytes -> bytes Result
*)

val rsa_encrypt: key -> bytes -> bytes Result
val rsa_decrypt: key -> bytes -> bytes Result
